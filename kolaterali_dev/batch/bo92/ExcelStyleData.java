...
{
    public static String cvsident = "@(#) $Header: /var/cvsroot/java/src/hr/vestigo/modules/collateral/batch/bo92/ExcelStyleData.java,v 1.1 2014/09/18 10:19:56 hrakis Exp $";
    
    public short dateFormat;
    public short numericFormat;
    public short generalNumericFormat;
    public short coefficientNumericFormat;
    ...
    public CellStyle normalCoefficientNumericStyle;
    ...
    public static ExcelStyleData createStyles(Workbook workbook)
    {
        ...
        styles.coefficientNumericFormat = format.getFormat("0.000");
        ...
        styles.normalCoefficientNumericStyle = workbook.createCellStyle();
        styles.normalCoefficientNumericStyle.setFont(styles.normalFont);
        styles.normalCoefficientNumericStyle.setDataFormat(styles.coefficientNumericFormat);
