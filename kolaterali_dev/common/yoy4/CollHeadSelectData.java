 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */ 
public class CollHeadSelectData {
	public static String cvsident = "@(#) $Header: /var/cvsroot/java/src/hr/vestigo/modules/collateral/common/yoy4/CollHeadSelectData.java,v 1.18 2017/06/01 12:03:38 hrazst Exp $";	 
	//input	
...
//	 sve iza ovog dodati u mapping za select !	
    ...
    /**ID podvrste kolaterala  - potrbno popuniti zbog odreðivanja GCTC polja*/
	...
	public String ColRba_txtEligDesc = null;
	  ...
	  public String Coll_txtLoanOwner = null;
	  public String Coll_txtLoanOwnerData = null;
      ...
      public String realization_cur_char=null;
      /**Datum realizacije*/
      ...
      /**Troškovi realizacije valuta id*/
      public BigDecimal realization_cost_cur_id=null;
      /**Troškovi realizacije valuta*/
      public String realization_cost_cur_code_char=null;
      ...
      public String toString(){
          ...
          buffy.append("\nColl_txtEUseIdLogin=["+Coll_txtEUseIdLogin+"]");
          buffy.append("\nColl_txtEUseIdLoginOIB=["+Coll_txtEUseIdLoginOIB+"]");
          buffy.append("\nColl_txtEUseIdName=["+Coll_txtEUseIdName+"]");
          buffy.append("\nColl_txtEstnCurr=["+Coll_txtEstnCurr+"]");
          buffy.append("\nColl_txtCarrierRegisterNo=["+Coll_txtCarrierRegisterNo+"]");
          buffy.append("\nColl_txtCarrierName=["+Coll_txtCarrierName+"]");
          buffy.append("\nColl_txtOwnerRegisterNo=["+Coll_txtOwnerRegisterNo+"]");
          buffy.append("\nColl_txtOwnerName=["+Coll_txtOwnerName+"]");
          buffy.append("\nColl_txtThirdRightCurCodeChar=["+Coll_txtThirdRightCurCodeChar+"]");
          buffy.append("\nColl_txtUseOpenIdLogin=["+Coll_txtUseOpenIdLogin+"]");
          buffy.append("\nColl_txtUseOpenIdName=["+Coll_txtUseOpenIdName+"]");
          buffy.append("\nColl_txtUseIdLogin=["+Coll_txtUseIdLogin+"]");
          buffy.append("\nColl_txtUseIdName=["+Coll_txtUseIdName+"]");
          buffy.append("\nColl_txtAmortPerCal=["+Coll_txtAmortPerCal+"]");
          buffy.append("\nColl_txtCollTypeName=["+Coll_txtCollTypeName+"]");
          buffy.append("\nUSER_LOCK=["+USER_LOCK+"]");
          buffy.append("\nColl_txtNmValCurr=["+Coll_txtNmValCurr+"]");
          buffy.append("\nColl_txtAcumBuyValue=["+Coll_txtAcumBuyValue+"]");
          buffy.append("\nColl_txtEligibility=["+Coll_txtEligibility+"]");
          buffy.append("\nColl_txtEligDesc=["+Coll_txtEligDesc+"]");
          ...
          buffy.append("\nC_txtUseIdSndVerLogin=["+C_txtUseIdSndVerLogin+"]");
          buffy.append("\nC_txtUseIdSndVerName=["+C_txtUseIdSndVerName+"]");
          buffy.append("\nC_txtUseIdVerLogin=["+C_txtUseIdVerLogin+"]");
          buffy.append("\nC_txtUseIdVerName=["+C_txtUseIdVerName+"]");
          buffy.append("\nC_txtUseIdAutLogin=["+C_txtUseIdAutLogin+"]");
          buffy.append("\nC_txtUseIdAutName=["+C_txtUseIdAutName+"]");
          buffy.append("\nColl_txtBasicDataSt=["+Coll_txtBasicDataSt+"]");
          buffy.append("\nColl_txtCollDataSt=["+Coll_txtCollDataSt+"]");
          buffy.append("\nColl_txtCoverIndic=["+Coll_txtCoverIndic+"]");
          buffy.append("\nColl_txtFinFlag=["+Coll_txtFinFlag+"]");
          buffy.append("\nColl_txtMortgageSt=["+Coll_txtMortgageSt+"]");
          buffy.append("\nKolLow_txtEligibility=["+KolLow_txtEligibility+"]");
          buffy.append("\nKolLow_txtEligDesc=["+KolLow_txtEligDesc+"]");
          buffy.append("\nColRba_txtEligibility=["+ColRba_txtEligibility+"]");
          buffy.append("\nColRba_txtEligDesc=["+ColRba_txtEligDesc+"]");
          buffy.append("\nKol_txtRbaEligDsc=["+Kol_txtRbaEligDsc+"]");
          buffy.append("\nColl_txtLoanOwner=["+Coll_txtLoanOwner+"]");
          buffy.append("\nColl_txtLoanOwnerData=["+Coll_txtLoanOwnerData+"]");
          buffy.append("\nColl_txtNumOf=["+Coll_txtNumOf+"]");
          buffy.append("\nColl_txtB1Eligibility=["+Coll_txtB1Eligibility+"]");
          buffy.append("\nColl_txtB2IRBEligibility=["+Coll_txtB2IRBEligibility+"]");
          buffy.append("\nColl_txtB1EligDesc=["+Coll_txtB1EligDesc+"]");
          buffy.append("\nColl_txtB2IRBEligDesc=["+Coll_txtB2IRBEligDesc+"]");
          buffy.append("\nColl_txtNDEligibility=["+Coll_txtNDEligibility+"]");
          buffy.append("\nColl_txtNDEligDesc=["+Coll_txtNDEligDesc+"]");
          buffy.append("\nKol_txtCRMHnb=["+Kol_txtCRMHnb+"]");
          buffy.append("\nEVE_ID=["+EVE_ID+"]");
          buffy.append("\nKol_txtPonderMVP=["+Kol_txtPonderMVP+"]");
          ...
          buffy.append("\nrealization_cost_cur_code_char=["+realization_cost_cur_code_char+"]");
          buffy.append("\nfor_sale=["+for_sale+"]");
