...
---------------------------------------------- testiranje na Sidevu - 18.11.2013
---- testiram na nekom raèunu koji je vrste okvir   --- select * from bank_product_type where BAN_PRO_TYP_ID = 2245837003;
--1 dohvat okvira
select * from customer_account where BAN_PRO_TYP_ID = 2245837003;

-- dohvat nekog od tekuæih raèuna iz datoteke - naæi raèune koji su problematièni

select * from customer_account where BAN_PRO_TYP_ID = 2245837003
and cus_acc_no in (8100000422,
   100000395,
   100000563,
   8300000148,
   2600010252,
